...
[**Audio Monitor with Maui.Graphics**](projects/maui-audio-monitor) - This project uses NAudio to continuously sample the default microphone device, calculate the maximum intensity, and display it in a Windows Forms application using the SkiaSharp OpenGL control. | ![](projects/maui-audio-monitor/screenshot.gif)
...
---|---|---
![](/dev/old/drawing/mystify/screenshot.gif)|![](/dev/old/drawing/game-of-life/screenshot.gif)|![](/dev/old/drawing/boids/screenshot.gif)
